		...
		<footer class="site-footer">
			<p class="copyright">&copy; <?php echo date('Y'); ?> Jeff Bridgforth</p>

			<ul class="social-links">
				<li>
					<a rel="me" href="https://mastodon.social/@webcraftsman">
						<svg xmlns="http://www.w3.org/2000/svg" height="1em" fill="currentColor" viewBox="0 0 419 453">
							<path d="M 419 149 Q 418 101 402 73 L 402 73 Q 387 46 372 34 L 372 34 Q 356 23 355 23 L 355 23 Q 355 23 355 23 Q 322 9 266 4 Q 210 0 154 4 Q 98 9 65 23 Q 64 23 48 34 Q 33 46 18 73 Q 2 101 1 149 Q 1 158 1 167 Q 0 225 5 281 Q 9 338 32 380 Q 55 423 107 438 Q 168 453 210 450 Q 248 447 269 440 Q 289 432 289 432 Q 289 432 289 432 L 288 395 Q 287 395 264 400 Q 242 405 211 405 Q 179 405 153 396 Q 127 387 121 351 Q 120 344 120 337 Q 181 350 227 349 Q 274 348 294 344 Q 297 344 299 344 Q 342 338 373 316 Q 404 295 410 271 Q 417 230 418 191 Q 419 152 419 149 L 419 149 Z M 344 274 L 297 274 L 297 160 Q 296 135 281 127 Q 265 118 250 128 Q 234 138 233 167 L 233 230 L 187 230 L 187 167 Q 186 138 170 128 Q 155 118 140 127 Q 124 135 123 160 L 123 274 L 76 274 Q 76 243 76 219 Q 75 164 78 139 Q 81 114 95 99 Q 116 77 147 78 Q 179 78 198 105 L 210 125 L 222 105 Q 242 78 273 78 Q 304 77 325 99 Q 340 114 342 139 Q 345 164 344 219 Q 344 242 344 274 L 344 274 Z" />
						</svg>
						<span class="text sr-only">Mastodon</span>
					</a>
				</li>
				<li>
				...
				<li>
					<a href="https://codepen.io/webcraftsman">
						<svg xmlns="http://www.w3.org/2000/svg" height="1em" fill="currentColor" viewBox="0 0 512 520">
							<path
