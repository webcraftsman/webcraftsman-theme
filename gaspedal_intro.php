<?php
/*
Template Name: GasPedal Introduction
*/
?>
...
<!--[if IE 6]><link rel="stylesheet" type="text/css" href="http://universal-ie6-css.googlecode.com/files/ie6.0.2.css" media="screen, projection" /><![endif]-->
	...
	<body id="gaspedal_intro">
		<div id="wrapper">
			...
			<ul id="nav_main">
				<li id="current_page">Introduction</li>
				<li><a href="http://jeffbridgforth.com/gaspedal-realign">GasPedal Redesign</a></li>
