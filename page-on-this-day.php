...
<?php include('includes/body_id.php'); ?>
		...
		<main>
            <h1><?php the_title();?></h1>
        <?php $date_query = array(array('before' => array('year' => wp_date('Y'))));?>
        ...
        <div class="latest-posts">
			...
			<div class="post-listing grid">
                  <?php if ($day_query->have_posts()): ?>
				    ...
				    <?php endwhile; ?>
                    <?php else:?>
                        <p>No articles were written on this day. </p>
...
<?php wp_reset_query();?>
        <?php $notesArgs = array(
            ...
            $notes_query = new WP_Query($notesArgs);
        ?>
    ...
    <?php else:?>
        <p>No notes were posted on this day.</p>
	<?php endif;?>
    </div>
    </div>
<?php wp_reset_query();?>
